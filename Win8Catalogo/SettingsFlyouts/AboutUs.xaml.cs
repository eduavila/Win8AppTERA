...
namespace Win8Catalogo.SettingsFlyouts
{
    ...
    /// </summary>
    public sealed partial class AboutUs : LayoutAwarePage
    {
        public AboutUs()
        {
            this.InitializeComponent();
            if (!String.IsNullOrEmpty(Win8CatalogApplication.Instance.Empresa.SettingsSobre))
            {
                txtSobre.Text = Win8CatalogApplication.Instance.Empresa.SettingsSobre;
            }
        }
