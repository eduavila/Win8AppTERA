...
namespace Win8Catalogo.SettingsFlyouts
{
    ...
    public sealed partial class PrivacyPolicy : LayoutAwarePage
    {
        public PrivacyPolicy()
        {
            ...
            if (!String.IsNullOrEmpty(Win8CatalogApplication.Instance.Empresa.SettingsPolitica))
            {
                txtPrivacidade.Text = Win8CatalogApplication.Instance.Empresa.SettingsPolitica;
            }
        }
